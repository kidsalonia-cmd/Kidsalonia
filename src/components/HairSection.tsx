...
const hairServices = [
  ...
  { name: "MUNDAN AT SALON", description: "Traditional Mundan service at KidSalonia salon with care and hygiene.", price: "₹ 1100" },
  { name: "MUNDAN AT HOME (ONSITE)", description: "Mundan service at your home. One-way conveyance cost is additional.", price: "₹ 2100 + one-way conveyance" },
