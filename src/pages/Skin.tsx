  ...
  return (
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <section className="bg-primary py-16 text-center px-4">
        <h2 className="text-3xl md:text-4xl font-bold text-primary-foreground mb-4">Book a Skin Care Session Today</h2>
        <p className="text-primary-foreground/80 text-base md:text-lg max-w-2xl mx-auto mb-8">Give your child the gentlest, safest skin care experience in Gurugram. Call us or visit to book.</p>
