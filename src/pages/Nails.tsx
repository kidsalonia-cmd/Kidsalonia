  ...
  return (
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <section className="bg-primary py-16 text-center px-4">
        <h2 className="text-3xl md:text-4xl font-bold text-primary-foreground mb-4">Book a Nail Art Session Today</h2>
        <p className="text-primary-foreground/80 text-base md:text-lg max-w-2xl mx-auto mb-8">Treat your little one to the cutest nail art in Gurugram. Call us or visit to book an appointment.</p>
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <a href="tel:8130307036" className="bg-white text-primary font-bold px-8 py-3 rounded-full text-base hover:bg-white/90 transition">Call +91 8130307036</a>
          <a href="https://wa.me/918130307036" target="_blank" rel="noopener noreferrer" className="border-2 border-white text-white font-bold px-8 py-3 rounded-full text-base hover:bg-white/10 transition">Book Online</a>
        </div>
      </section>
